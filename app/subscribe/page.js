  ...
  return (
    <div className='w-screen h-screen relative flex justify-center items-center'>
      ...
      <div className='absolute flex flex-col justify-center items-center bg-transparent backdrop-blur-md border rounded-lg p-6 max-w-sm w-full'>
        <h2 className='text-center text-white font-bold text-2xl mb-4'>Details</h2>
        <form onSubmit={handleSubmit} className='w-full'>
          <div className='mb-4 w-full'>
            <label htmlFor='phone' className='block text-white text-sm font-semibold mb-2'>Phone Number</label>
            <div className='flex'>
              <select
                id='countryCode'
                value={countryCode}
          ...
          <div className='mb-4 w-full'>
            <label htmlFor='city' className='block text-white text-sm font-semibold mb-2'>City</label>
            <select
              id='city'
              value={selectedCity}
            ...
            >
              ...
              {selectedState && statesWithCities.find(state => state.state === selectedState).cities.map(city => (
